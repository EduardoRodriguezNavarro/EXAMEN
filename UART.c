...
//PAG 1351 PARA CHECAR PINES 


//CONFIGURACION DE UART 1
...
SYSCTL->RCGCUART  = (1<<1);   //Paso 1 (RCGCUART) pag.344 UART/modulo1 0->Disable 1->Enable
    ...
    */
    ...
    UART1->LCRH = (0x3<<5)|(1<<4);//Para que se tengan 8 bits, y |(1<<4); activar el bit de paridad pero solo con el uart0
    //  UART Clock Configuration(UARTCC) pag.939
    UART1->CC =(0<<0);/*PARA USAR EL RELOJ INTERNO*/
    //Disable UART0 UART Control (UARTCTL) pag.918
    UART1->CTL = (1<<0) | (1<<8) | (1<<9);//se habilitan los pines de recepción, el pin 8 y 9 se deben prender juntos
}
